%% 非对称学习因子的粒子群算法 PSO：求解函数 y = x1^2 + x2^2 - x1 * x2 - 10 * x1 - 4 * x2 + 60 在 [-15, 15] 内的最小值（动画演示）
clear; clc
% 毛开富, 包广清, 徐驰. 基于非对称学习因子调节的粒子群优化算法[J]. 计算机工程, 2010(19):188-190.（公式 10 中的减号应该改为加号）
